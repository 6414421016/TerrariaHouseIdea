...
import 'playdetail01_model.dart';
export 'playdetail01_model.dart';

class Playdetail01Widget extends StatefulWidget {
  const Playdetail01Widget({
    Key? key,
    this.detail,
  }) : super(key: key);
  ...
  @override
  _Playdetail01WidgetState createState() => _Playdetail01WidgetState();
}

class _Playdetail01WidgetState extends State<Playdetail01Widget> {
  late Playdetail01Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Playdetail01Model());
  }
                      ...
                      children: [
                        Padding(
                          ...
                          child: FlutterFlowYoutubePlayer(
                            url:
                                'https://youtu.be/nSZCACk-c7Q?si=2M8xKeI0YrJpElH6',
                            autoPlay: false,
                            looping: true,
                            mute: false,
                            showControls: true,
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    10.0, 10.0, 0.0, 0.0),
                                child: Text(
                                  'Terraria 1.4 สไตร์สร้างบ้าน Ep.16',
