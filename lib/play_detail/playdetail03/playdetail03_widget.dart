...
import 'playdetail03_model.dart';
export 'playdetail03_model.dart';

class Playdetail03Widget extends StatefulWidget {
  const Playdetail03Widget({
    Key? key,
    this.detail,
  }) : super(key: key);
  ...
  @override
  _Playdetail03WidgetState createState() => _Playdetail03WidgetState();
}

class _Playdetail03WidgetState extends State<Playdetail03Widget> {
  late Playdetail03Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Playdetail03Model());
  }
                      ...
                      children: [
                        Padding(
                          ...
                          child: FlutterFlowYoutubePlayer(
                            url:
                                'https://youtu.be/ZIzArrcvsaQ?si=PWO7jcanUins8t_a',
                            autoPlay: false,
                            looping: true,
                            mute: false,
                            showControls: true,
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    10.0, 10.0, 0.0, 0.0),
                                child: Text(
                                  'Terraria 1.4 สไตร์สร้างบ้าน Ep.14',
