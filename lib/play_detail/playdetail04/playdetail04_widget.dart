...
import 'playdetail04_model.dart';
export 'playdetail04_model.dart';

class Playdetail04Widget extends StatefulWidget {
  const Playdetail04Widget({
    Key? key,
    this.detail,
  }) : super(key: key);
  ...
  @override
  _Playdetail04WidgetState createState() => _Playdetail04WidgetState();
}

class _Playdetail04WidgetState extends State<Playdetail04Widget> {
  late Playdetail04Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Playdetail04Model());
  }
                      ...
                      children: [
                        Padding(
                          ...
                          child: FlutterFlowYoutubePlayer(
                            url:
                                'https://youtu.be/MgaqZTa6aRo?si=8HuTCVcOtzrFnYRD',
                            autoPlay: false,
                            looping: true,
                            mute: false,
                            showControls: true,
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    10.0, 10.0, 0.0, 0.0),
                                child: Text(
                                  'Terraria 1.4 สไตร์สร้างบ้าน Ep.13',
